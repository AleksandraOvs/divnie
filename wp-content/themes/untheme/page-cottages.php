...
/**
 * Template name: Шаблон Остекление коттеджей
 */
get_header();
?>
...
<main id="primary" class="site-main">
    ...
    <div class="page-section">
        <header class="page-header _template-header">
            ...
            <div class="fixed-container">
                <div class="page-title__left">
                    ...
                    ?>
                    <?php
                    if ($header_text = carbon_get_theme_option('crb_cotgs_header_text')) {
                ...
                <?php
                if ($header_accent = carbon_get_theme_option('crb_cotgs_header_accent')) {
                    echo '<div class="template-header__accent">' . $header_accent;

                    if ($header_accent_link = carbon_get_theme_option('crb_cotgs_header_accent_link')) {
                        $header_accent_link_text = carbon_get_theme_option('crb_cotgs_header_accent_link_text');
                ?>
                        <a class="btn" href="">
                            <?php
        ...
        <div class="page-section__content">
            ...
            <?php
            get_template_part('template-parts/cottages/advantages-cottages');
            ?>
            ...
            <section class="template-products">
                <div class="fixed-container">
                    <?php
                    // Название секции
                    $section_name = carbon_get_theme_option('crb_cotgs_name_section');
                    if (!empty($section_name)) : ?>
                        <h2 class="title"><?php echo $section_name ?></h2>
                    <?php endif; ?>
                    <?php get_template_part('template-parts/cottages/content-product') ?>
                </div>
            </section>



            <?php get_template_part('template-parts/cotgs/about-section') ?>
