...
$products_section_head = carbon_get_theme_option('crb_cotgs_name_section');
// echo '<pre>';
// print_r($products);
...
if ($products) : ?>
    ...
    <div class="product-cards _cotgs_cards">
        <?php foreach ($products as $product) : ?>
            <div class="product-card product-cotg">
                ...
                <div class="product-card__content">
                    <div class="product-card__info">
                        ...
                        <?php if (!empty($product['crb_cotgs_product_desc'])) : ?>
                            <div class="product-desc"><?php echo esc_html($product['crb_cotgs_product_desc']); ?></div>
                        <?php endif; ?>
                    </div>

                    <!-- Преимущества -->
                    <?php if (!empty($product['crb_cotgs_product_adv']) && is_array($product['crb_cotgsadv_product_adv'])) : ?>
                        <ul class="product-advantages">
                            <?php foreach ($product['crb_cotgsadv_product_adv'] as $adv) : ?>
                                <?php
                                // пропускаем пустые
                                if (
                                    empty($adv['crb_cotgsadv_product_adv_icon'])
                                    && empty($adv['crb_cotgsadv_product_adv_key'])
                                    && empty($adv['crb_cotgsadv_product_adv_value'])
                                ) {
                                    continue;
                                }
                                ?>
                                <li>
                                    <?php if (!empty($adv['crb_cotgsadv_product_adv_icon'])) : ?>
                                        <div class="adv-icon">
                                            <img src="<?php echo esc_url(wp_get_attachment_image_url($adv['crb_cotgsadv_product_adv_icon'], 'thumbnail')); ?>" alt="">
                                        </div>
                                    <?php endif; ?>

                                    <?php if (!empty($adv['crb_cotgsadv_product_adv_text'])) : ?>
                                        <div class="adv-text">
                                            <?php echo $adv['crb_cotgsadv_product_adv_text'] ?>
                                        </div>
                                    <?php endif; ?>
                                </li>
                            <?php endforeach; ?>
                        ...
                        <?php if (!empty($product['crb_cotgs_name_link'])) : ?>
                            <a class="btn" href="<?php echo esc_url($product['crb_cotgs_name_link']); ?>">
                                ...
                                echo !empty($product['crb_cotgs_name_link_text'])
                                    ...
                                    : esc_html($product['crb_cotgs_name']);
                                ?>
                            </a>
                        <?php endif; ?>
                    </div>
